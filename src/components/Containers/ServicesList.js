	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col">
				...
				<p class="text-muted">
					Finding third-party subcontractors qualified to handle your project is
					a hit or miss.
					<br />
					<p class="text-muted">
						Our specialized team of stone fabricators use the highest quality do
			...
			<div class="col">
				...
				<p class="lead">
					Our in-house team of stone installation specialists willElimate the
