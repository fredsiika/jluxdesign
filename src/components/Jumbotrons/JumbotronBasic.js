        ...
        <Container className="mt-5">
          <Row>
            <Col>
              ...
              <h1 className="text display-1">
                Countertop estimation<br />{' '}made simple
              </h1>
              <div className="header-description">
                <p className="lead">
                  Get a countertop quote in less than a minute.<br />{' '}
                  <span className="text-primary">JLuxDesigns'</span> Countertop Estimator Form gives our team an approximate price for your countertop project.
                </p>

                <hr className="my-2" />
                <small className="text-muted">
                  Not all options or materials are represented within this form.<br />{' '}
                  Quoted price and scope of project may be different than the final cost for various reasons.<br />{' '}
