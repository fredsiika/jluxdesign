					...
					<Col md="6">
						<div className="pl-md-5">
							...
							<p className="display-4 pb-3">
								Find the perfect material match for your lifestyle at
								JLuxDesign.com
							</p>
							<p className="display-4">
								We proudly offer an extensive library of over 2,000 colors of
								stone.
							</p>
							<Button
								aria-pressed={true}
						...
						<Card className="bg-dark shadow border-0">
							...
							<blockquote className="card-blockquote">
								...
								<p className="lead text-italic text-white">
									Our Eco-Thinking means high-quality, long-lasting materials
