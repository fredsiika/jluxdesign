								...
								<Card className="text-left card-lift--hover shadow border-0">
									<CardBody className="py-5">
										...
										<p className="lead text-strong mt-3">
											...
											<br /> Having the it in stock is even more critical.
										</p>
										<p className="description mt-3">
											With well over 50,000 slabs of stone in stock, JLuxDesign
											is ready to handle your project.
										</p>
										<Button
											className="mt-4"
											color="darker"
							...
							<Col lg="4">
								<Card className="text-left card-lift--hover shadow border-0">
									<CardBody className="py-5">
										...
										<p className="lead text-strong">
											Eliminate wasted time and money from outsourcing.
										</p>
										<p className="description mt-3">
											Our in-house team of professional fabricators guarantee
											the level of craftsmanship for the perfect stone cut.
											<br />
											<br />
											JLuxDesign processes hundreds of countertops every week
											with CNC enabled machinery
										</p>
										<Button
											className="mt-4"
											color="darker"
							...
							<Col lg="4">
								<Card className="text-left card-lift--hover shadow border-0">
									<CardBody className="py-5">
										...
										<p className="description mt-3">
											From template to installation, we work with homeowners to
											ensure a hassle-free experience.
											<br /> Our customer service team is here to create the
											home of your dreams.
										</p>
										<Button
											className="mt-4"
