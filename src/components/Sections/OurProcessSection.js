		...
		<section className="section section-lg pt-lg-0 mt--200 mb-9 bg-dark">
			<div className="container">
              ...
              /> */}
								...
								<h4 className="display-6 text-black text-uppercase mb-1">
									Get a quote
								</h4>
								<p className="text-default mb-0">
									Getting a quote now is easier than ever, choose one of our 3
									convenient methods to receive an accurate estimate for any
									project.
								</p>
							</a>
							{/* // End Icon Block */}
                  ...
                  /> */}
								...
								<h4 className="display-6 text-uppercase text-dark mb-1">
									Choose a stone
								</h4>
								<p className="text-default mb-0">
									When visiting one of our locations, you’ll have the unique
									opportunity to view full slabs and receive free samples.
								</p>
							</a>
							{/* // End Icon Block */}
						</div>
                ...
                /> */}
								...
								<h4 className="display-6 text-dark text-uppercase mb-1">
									Schedule Templating
								</h4>
								<p className="text-default mb-0">
									After you’ve selected the ideal stone color for your project,
									it’s time to schedule a templating appointment. During this
									process, a trained technician will use industry leading laser
									technology to properly measure your countertop space.{' '}
								</p>
							</a>
							{/* // End Icon Block */}
						</div>
                ...
                /> */}
								...
								<p className="text-default mb-0">
									When your template has been created, it’s time to confirm the
									layout of the project on the slab. It's now time for your
									stone to be installed and sealed.
								</p>
							</a>
							{/* // End Icon Block */}
						</div>
