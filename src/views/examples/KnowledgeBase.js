		...
		<>
			...
			<div className="hero-animation bg-gradient-darker mb-2">
				<div className="HeroGroup text-left">
					<p className="lead text-left text-success text-uppercase">Knowledge Base</p>
					...
					<Link to="/quote" className="text-primary display-4">Learn more about tile and stone</Link>
				</div>
			</div>
			<div className="main">
						...
						<Container>
							<Row>
								...
								<Col className="hero-animation-2">
									<div className="">
										<p className="lead text-left text-uppercase text-primary">Materials</p>
										<h3 className="display-2 text-gray-dark">Popular stones for your next project.</h3>
										<p className="display-4 text-left text-muted">
											Below are some of the most popular and beautiful natural stones available.<br />{' '}
										</p>
									</div>
						...
						<div className="">
							<Row>
								<Col className="hero-animation-3">
									<div className="">
										<p className="lead text-left text-uppercase text-primary">Customer Satisfaction</p>
										<h3 className="display-2 text-gra-dark">Can't find a particular stone?</h3>
										<p className="display-4 text-left text-muted">
											If you don’t see the color you want our stone suppliers we have over 200 different colors available for you to choose from.
										</p>
										<Link to="/contact" className="text-primary display-3">Get in touch with us.</Link>
									</div>
								</Col>
							</Row>
							</div>
